    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 text-left text-green-600 px-6 max-w-4xl">
          ...
          >
            Department of Forest Protection and Security
          </h1>
          <p
        ...
        >
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/2">
              <Image
                src="/kfc/images/mwan.jpeg"
                alt="Mr. Appolinary Mwandigha"
                width={600}
                height={400}
...
export default ProtectionSecurity;