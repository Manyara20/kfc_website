        ...
        >
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/2">
              <Image
                src="/kfc/images/rwane.png"
                alt="Ms. Joannes Rwane"
                width={600}
                height={400}
                className="w-full h-64 md:h-144 object-fit"
              />
            </div>
            {/* Text */}
            <div className="md:w-1/2">
          ...
          <div className="mt-8">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border-collapse">
                ...
                <tbody>
                  {[
                    { sno: 1, programme: 'Diploma in Environmental Management', authority: 'TVET CDACC', requirements: 'KCSE Mean Grade C- (Minus)', duration: '2 Years' },
                    { sno: 2, programme: 'Landscaping Technology', authority: 'Internal', requirements: 'Basic Literacy', duration: '2 Weeks' },
                    { sno: 3, programme: 'Managing Climate Change', authority: 'Internal', requirements: 'Basic Literacy', duration: '2 Weeks' },
                  ].map((course) => (
                    <tr key={course.sno} className="even:bg-gray-100">
                      ...
                      <td className="border border-gray-300 p-2 font-['Peugeot',Helvetica,outfit,sans-serif]" style={{ fontSize: `${fontSize * 0.9}px` }}>{course.duration}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
