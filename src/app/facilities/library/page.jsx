...
const forestList = [
  ...
  {
    name: 'Tree Nurseries',
    image: '/kfc/nursery/nurserya.jpg',
...
const Library = () => {
  ...
  return (
    <div>
      ...
      {/* Hero */}
      <div
        className="relative h-[60vh] bg-cover bg-center flex items-center justify-center bg-[url('/kfc/facility/lib.jpg')]"
      >
        ...
        <div className="relative z-10 text-center text-green-600 px-6 max-w-4xl">
          ...
          >
            Kenya Forestry College Library
          </h1>
          <p
            className="font-['Peugeot',Helvetica,sans-serif] font-normal text-white leading-[1.8] text-[1rem] mt-4"
            style={{ fontSize: `${fontSize * 0.9}px` }}
          >
            A dynamic information resource center empowering sustainable forest and environmental management.
          </p>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/2">
              <Image
                ...
                alt="Kenya Forestry College Library"
                width={600}
                height={400}
            ...
            <div className="md:w-1/2">
              ...
              <p
                ...
                style={{ fontSize: `${fontSize * 0.9}px` }}
              >
                Kenya Forestry College Library is more than a repository of books—it is a dynamic information resource center that bridges classroom theory, field practice, and cutting-edge research, empowering trainees to drive sustainable forest and environmental management across Kenya and beyond. The library blends print, digital, and field resources to create a holistic learning environment.
              </p>
              <h3
                className="font-['Peugeot',Helvetica,sans-serif] font-semibold text-[#0f5a28] mb-2"
                style={{ fontSize: `${fontSize * 1.1}px` }}
              >
                Key Strengths & Collections
              </h3>
              <ul
                className="font-['Peugeot',Helvetica,sans-serif] font-normal text-black leading-[1.8] text-[0.9rem] list-disc pl-5 mb-4"
                style={{ fontSize: `${fontSize * 0.9}px` }}
              >
                <li>
                  <strong>Specialized Forestry & Environmental Holdings</strong> – 10,000+ print volumes, atlases, technical manuals, and historic forestry texts, complemented by grey literature from the Kenya Forest Service. Periodic donations from practicing and retired foresters keep the collection current and rich in local context.
                </li>
                <li>
                  <strong>Digital Knowledge Hub</strong> – 24/7 access to electronic resources via e-library for peer-reviewed journals, e-books, and datasets across forestry, climate science, GIS, ecology, and allied disciplines.
                </li>
              </ul>
              <h3
                className="font-['Peugeot',Helvetica,sans-serif] font-semibold text-[#0f5a28] mb-2"
              ...
              <ul
                ...
                style={{ fontSize: `${fontSize * 0.9}px` }}
              >
                <li><strong>Research & Citation Support</strong> – One-on-one consultation, literature-search assistance.</li>
                <li><strong>Information-Literacy Training</strong> – Mandatory orientation for new students.</li>
                <li><strong>Interlibrary Loan</strong> – Collaboration with KFS headquarter library and other institutions.</li>
                <li><strong>Ask-a-Librarian & Remote Help Desk</strong> – Email and chat support is readily available.</li>
              </ul>
              <h3
                className="font-['Peugeot',Helvetica,sans-serif] font-semibold text-[#0f5a28] mb-2"
                style={{ fontSize: `${fontSize * 1.1}px` }}
              ...
              <table
                className="font-['Peugeot',Helvetica,sans-serif] font-normal text-black leading-[1.8] text-[0.9rem] w-full border-collapse"
                style={{ fontSize: `${fontSize * 0.9}px` }}
              >
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td className="border border-gray-300 p-2">Monday – Friday</td>
                    <td className="border border-gray-300 p-2">8:30 AM – 9:00 PM</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 p-2">Saturday</td>
                    <td className="border border-gray-300 p-2">9:00 AM – 1:00 PM</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 p-2">Sunday & Public Holidays</td>
