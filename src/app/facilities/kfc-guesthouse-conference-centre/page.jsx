      ...
      >
        ...
        >
          ...
          <section className="mb-12">
            <h1
              className="font-['Peugeot',Helvetica,sans-serif] font-bold text-[#fe7c02] drop-shadow-[1px_1px_2px_rgba(0,0,0,0.1)] mb-2 text-[2.2rem] leading-[1.3] tracking-[0.5px] capitalize"
              style={{ fontSize: `${fontSize * 1.5}px` }}
            >
              KFC Guesthouse & Conference Centre
            </h1>
            <p
              className="font-['Peugeot',Helvetica,sans-serif] font-normal text-[#fe7c02] leading-[1.8] text-[1rem] mb-6"
            ...
            <div className="relative h-64 md:h-96  overflow-hidden mb-8">
              <Image
                src="/kfc/facility/Hospitality.jpg"
          ...
          <section className="mb-12">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h2
                  className="font-['Peugeot',Helvetica,sans-serif] font-bold text-[#fe7c02] text-3xl mb-4"
                ...
                <div className="bg-green-50 p-6 ">
                  <h3
                    className="font-['Peugeot',Helvetica,sans-serif] font-semibold text-[#fe7c02] mb-3"
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      <li
                        key={index}
                        className="bg-[#fe7c02] transition-transform duration-300 hover:-translate-y-[2px] hover:shadow-[0_2px_8px_rgba(0,0,0,0.15)] p-4"
                      >
                        <span
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="relative h-64  overflow-hidden order-last md:order-first">
                <Image
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <div className="bg-green-50 p-6  mb-4">
                  <h3
                    className="font-['Peugeot',Helvetica,sans-serif] font-semibold text-[#fe7c02] mb-3"
                    style={{ fontSize: `${fontSize * 0.95}px` }}
                  >
          ...
          <section className="mb-12">
            <h2
              className="font-['Peugeot',Helvetica,sans-serif] font-bold text-[#fe7c02] text-3xl mb-6 text-center"
              style={{ fontSize: `${fontSize * 1.2}px` }}
            >
              Facility Highlights
            </h2>
          ...
          {/* Booking Section */}
          <section className="mb-12 bg-[#fe7c02] text-white p-8 ">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="bg-white text-[#fe7c02] p-6 ">
                <h3
