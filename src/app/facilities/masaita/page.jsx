...
const Masaita = () => {
  ...
  return (
    <div>
      ...
      {/* Hero */}
      <div
        className="relative h-[60vh] bg-cover bg-center flex items-center justify-center bg-[url('/kfc/masaita/masaita.jpeg')]"
      >
        ...
        >
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/2">
              ...
              >
                About Masaita Forest Block
              </h2>
              <p
                className="font-['Peugeot',Helvetica,sans-serif] font-normal text-black leading-[1.8] text-[0.9rem]"
                style={{ fontSize: `${fontSize * 0.9}px` }}
              >
                The forest has an area of 4,152ha and is part of the Mau complex within Mau Conservancy in Kericho County.
                Was gazetted as forest reserve vide proclamation notice No 44 of 1932 as part of Londiani station. But it was officially declared forest station with one block in 1962 and was handed over to KFC in 1976 being under college management and administration use as training block for the College
              </p>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  caption: 'Scenic view of Masaita Forest',
                },
                {
                  src: '/kfc/masaita/cave.jpg',
                  alt: 'Masaita Forest trail',
                  caption: 'Trail in Masaita Forest',
                },
                {
                  src: '/kfc/masaita/waterfall.jpg',
                  alt: 'Masaita Forest wildlife',
                  caption: 'Wildlife in Masaita Forest',
                },
              ].map((image, i) => (
