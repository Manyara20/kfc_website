...
const Hostel = () => {
  ...
  return (
    <div>
      ...
      {/* Hero */}
      <div
        className="relative h-[60vh] bg-cover bg-center flex items-center justify-center bg-[url('/kfc/facility/comp_lab.jpg')]"
      >
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/2">
              ...
              <p
                ...
                style={{ fontSize: `${fontSize * 0.9}px` }}
              >
                Our state-of-the-art computer lab at Kenya Forestry College is equipped with 40 modern workstations designed to support hands-on digital training for our students. The facility plays a vital role in building essential ICT skills, including document preparation, data analysis, digital design, and online communication. Students receive practical instruction using
                 industry-standard software such as Microsoft Office, SPSS, and AutoCAD, ensuring they are well-prepared to thrive in today’s dynamic and technology-driven world.
              </p>
            </div>
          </div>
