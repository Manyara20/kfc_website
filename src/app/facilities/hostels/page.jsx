...
const Hostel = () => {
  ...
  return (
    <div>
      ...
      {/* Hero */}
      <div
        className="relative h-[60vh] bg-cover bg-center flex items-center justify-center bg-[url('/kfc/facility/hostel.jpg')]"
      >
